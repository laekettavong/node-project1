const Constants = {
    ...
    DisplayText : {
        ...
        ERRORS_ENCOUNTERED_DELETE_CHECKS : 'Errors encountered while ttempting to delete all of the user\'s checks. All checks may not have been deleted from the system successfully.'
    },
    Arrays : {
